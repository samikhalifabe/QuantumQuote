...
export function InfoCard({ info }: InfoCardProps) {
  return (
    <div className="flex items-center gap-4 bg-secondary hover:bg-secondary/80 rounded-xl p-4 border border-border hover:border-primary/30 transition-all duration-200">
